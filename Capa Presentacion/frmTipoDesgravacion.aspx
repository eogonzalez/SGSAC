        ...
        <asp:Panel ID="pnlNuevoTipoDesgravacion" CssClass="panel panel-primary" runat="server" BorderColor="Black" BackColor="White"
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    <asp:Label ID="lbl_IdTipoDesgravacion" CssClass="control-label col-xs-4" enabled="false" runat="server"  Text="Codigo: "></asp:Label>
                    <div class="col-xs-8">
                        <asp:TextBox ID="txtIdTipoDesgravacion" type="text" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
                </div>
