<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/General.Master" CodeBehind="frmSubpartidas.aspx.vb" Inherits="Capa_Presentacion.frmSubpartidas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Configurar Subpartidas </div>
        ...
        <div class="panel-body form-horizontal">
            ...
            <div class="form-group">
                ...
                <div>
                    <asp:Label ID="lbl_codigo_arancel" CssClass="control-label col-xs-2" Text="Código Subpartida:" runat="server"></asp:Label>
                    <div class="col-xs-5">
                        <asp:TextBox ID="txt_codigo_subp" CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <div class="form-group">
                <div class="btn-group pull-right">
                    ...
                    <cc1:ModalPopupExtender ID="lkBtn_Nuevo_ModalPopupExtender" runat="server"
                        ...
                        PopupControlID="pnlSubPartidas" DynamicServicePath="" TargetControlID="lkBtn_Hidden_Nuevo">
            ...
            <div class="table-responsive">
                ...
                <asp:GridView ID="gvSubPartidas" runat="server"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:RadioButton ID="rb_subpartida" runat="server" OnClick="javascript:SelectSingleRadiobutton(this.id)" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="capitulo" HeaderText="Capitulo" />
                        <asp:BoundField DataField="partida" HeaderText="Partida" />
                        <asp:BoundField DataField="subpartida" HeaderText="SubPartida" />
                        <asp:BoundField DataField="texto_subpartida" HeaderText="Descripcion" />
                    </Columns>
                </asp:GridView>
    ...
    <div>
        <asp:Panel ID="pnlSubPartidas" CssClass="panel panel-primary"
            BorderColor="Black" BackColor="White" BorderStyle="Inset" BorderWidth="1px"
            Height="300" Width="30%" runat="server">
            <div class="panel-heading">Datos de Subpartida</div>
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    <div>
                        <asp:Label ID="lbl_codigo_subpartida" CssClass="control-label col-xs-3" Text="Código SubPartida: " runat="server"></asp:Label>
                        <div class="col-xs-3">
                            <asp:TextBox ID="txt_codigo_subpartida" type="text" CssClass="form-control" runat="server"></asp:TextBox>
                            <span class="help-block"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div>
                        <asp:Label ID="lbl_descripcion_partida" CssClass="control-label col-xs-3" Text="Descripción SubPartida:" runat="server"></asp:Label>
                        <div class="col-xs-9">
                            <asp:TextBox ID="txt_descripcion_subpartida" type="text" CssClass="form-control" runat="server"></asp:TextBox>
                            <span class="help-block"></span>
                        </div>
                    </div>
                </div>
