...
Partial Public Class frmConsultaVerSAC
    ...
    '''<summary>
    '''Control lbl_nombre_version.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lbl_nombre_version As Global.System.Web.UI.WebControls.Label

    '''<summary>
    '''Control ddl_version_SAC.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents ddl_version_SAC As Global.System.Web.UI.WebControls.DropDownList

    '''<summary>
    '''Control lbl_todas_capitulos.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lbl_todas_capitulos As Global.System.Web.UI.WebControls.Label
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cb_capitulo As Global.System.Web.UI.WebControls.CheckBox

    '''<summary>
    '''Control lbl_capitulo.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lbl_capitulo As Global.System.Web.UI.WebControls.Label
